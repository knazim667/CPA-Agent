...
from skills.sheets_formatter import (
    SHEET_DASHBOARD, SHEET_LEDGER, SHEET_PNL,
    apply_accounting_layout as _apply_accounting_layout,
    column_letter as _column_letter_fn,
    format_currency_column as _format_currency_column,
)
...
class GoogleSheetsManager:
    ...
    def format_currency_column(
        self, spreadsheet_id: str, sheet_id: int, start_column_index: int, end_column_index: int,
    ) -> dict[str, Any]:
        return _format_currency_column(self._execute, spreadsheet_id, sheet_id, start_column_index, end_column_index)

    def apply_accounting_layout(self, spreadsheet_id: str, sheet_map: dict[str, int]) -> dict[str, Any]:
        return _apply_accounting_layout(self._execute, self.format_currency_column, spreadsheet_id, sheet_map)

    @staticmethod
    def _column_letter(column_number: int) -> str:
        return _column_letter_fn(column_number)
